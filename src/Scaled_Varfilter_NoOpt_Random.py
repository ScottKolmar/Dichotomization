...
parent_path = r'C:\Users\skolmar\PycharmProjects\Modeling\Dichotomization\Experiment PKL\Solv\1000_Scaled_VarFilt75_NoOpt_Random'
dataset = DataSet(csv_file)
dataset.load_dataframe(sample_size = None, num_noise_levels=1, parent_path=parent_path)
var_thresh = np.percentile(dataset.X.var(), 75)
